...
export default function MentorPage() {
  ...
  const toggleListening = () => {
    ...
    recognition.onerror = () => {
      setIsListening(false);
      setMentorState("idle");
      setSubtitle("Couldn't hear you. Try again.");
    };
      ...
      <div className="max-w-lg w-full flex flex-col items-center text-center">
        ...
        <div className="mt-2 flex items-center gap-2">
          {(["idle", "listening", "thinking", "explaining", "celebrating"] as MentorState[]).map((s) => (
            <motion.div
              ...
              animate={mentorState === s ? { scale: [1, 1.5, 1] } : { scale: 1 }}
        ...
        <div className="mt-5 flex items-center gap-4">
          ...
          <button
            ...
            className={`p-5 rounded-full transition-all ${isListening ? "bg-destructive text-destructive-foreground animate-pulse" : "bg-primary text-primary-foreground hover:opacity-90 glow-primary"} disabled:opacity-40`}
          >
